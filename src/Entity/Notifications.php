...
class Notifications
{
    ...
    public function getIsReadDistributor(): ?bool
    {
        return $this->isReadDistributor;
    }

    public function setIsReadDistributor(?bool $isReadDistributor): self
    {
        $this->isReadDistributor = $isReadDistributor;
